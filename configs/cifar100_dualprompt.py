...
def get_args_parser(subparsers):
    ...
    # Model parameters vit_base_patch16_224 maxvit_small_tf_224
    ...
    #                     help='if online learning or offline learning, that is, epoch=1 or not')
    ...
    subparsers.add_argument('--evolve_epoch', default=2, type=int,) # if -1, evolve at last epoch
    ...
    subparsers.add_argument('--film_train_epoch', default=10, type=int,) # if -1, evolve at last epoch
    ...
    subparsers.add_argument('--sampling_size_for_remerge', default=1000, type=int,) # if -1, evolve at last epoch
    subparsers.add_argument('--save_prepgroup_info', action='store_true', help='save_prepgroup')
    subparsers.add_argument('--kmeans_run', default=100, type=int,) # if -1, evolve at last epoch
    subparsers.add_argument('--kmeans_top_n', default=2, type=int,) # if -1, evolve at last epoch
    ...
    subparsers.add_argument('--freeze', default=['blocks', 'patch_embed', 'cls_token', 
                                'norm', 'pos_embed', 'e_prompt.film.weight', 'e_prompt.film.bias'], 
