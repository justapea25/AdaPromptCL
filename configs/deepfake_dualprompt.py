...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--deepfake_tasks', default=['gaugan', 'biggan', 'stylegan', 'stargan'], nargs='+', type=str, help='deepfake task names')
    ...
    subparsers.add_argument('--train_mask', action='store_false', help='if specified, train_mask = false')
    ...
    subparsers.add_argument('--size', default=100, type=int, help='prompt pool size')
    subparsers.add_argument('--length', default=5, type=int, help='prompt length')
    subparsers.add_argument('--top_k', default=5, type=int, help='top k prompts')
    ...
    # AdaPromptCL specific parameters
    ...
    subparsers.add_argument('--postmerge_thrh', type=float, default=0.6, help='post-merge threshold')
