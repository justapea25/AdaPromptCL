...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--epochs', default=4, type=int)
    ...
    # Data parameters
    subparsers.add_argument('--data-path', default='/path/to/deepfake/data', type=str, help='dataset path')
    subparsers.add_argument('--dataset', default='Deepfake', type=str, help='dataset name')
    subparsers.add_argument('--shuffle', action='store_false', help='if specified, shuffle = false')
    ...
    subparsers.add_argument('--train_mask', action='store_false', help='if specified, train_mask = false (disable class masking for binary classification)')
    ...
    subparsers.add_argument('--binary_evaluation', action='store_true', help='use binary evaluation for deepfake (even=real, odd=fake)')
    ...
    subparsers.add_argument('--pull_constraint', default=False)  # Disable for Deepfake to prevent negative loss
    subparsers.add_argument('--pull_constraint_coeff', default=0.1, type=float)  # Reduced coefficient
    ...
    subparsers.add_argument('--num_coda_prompt', default=10, type=int,)

    # feature-prompt
    subparsers.add_argument('--feat_prompt', action='store_true', help='feature prompt')
    subparsers.add_argument('--num_feat_prompt', default=100, type=int,)
    ...
    subparsers.add_argument('--ptm_num_feat_prompt', default=10, type=int,)
    ...
    subparsers.add_argument('--evolve_epoch', default=2, type=int,)
    ...
    # ablation: {avg, post}-merge
    subparsers.add_argument('--avg_merge', action='store_true', help='avg_merge')
    subparsers.add_argument('--ema_merge', action='store_true', help='avg_merge')
    
    # post-merge
    subparsers.add_argument('--postmerge_thrh', type=float, default=0.6, help='if > thrh, then converge')
    subparsers.add_argument('--mergable_prompts', action='store_true', help='mergable_prompts')
    ...
    subparsers.add_argument('--converge_thrh', type=float, default=0.4, help='if > thrh, then converge')
    ...
    # vtab similar tasks (not applicable for deepfake but needed for compatibility)
    ...
    # VTAB datasets (needed for compatibility)
    subparsers.add_argument('--vtab_datasets', default=[], nargs='+', type=str, help='vtab_datasets')

    # overlapping datasets parameters (needed for compatibility)
    ...
    subparsers.add_argument('--overlap_dataset_scale', type=float, default=0.5, help='')
    subparsers.add_argument('--overlap_datasets', default=[], nargs='+', type=str, help='overlap_datasets')
    ...
    subparsers.add_argument('--freezeG_t', default=1, type=int,)
    subparsers.add_argument('--freezeG_e', default=-1, type=int,)
    ...
    subparsers.add_argument('--noisy_policy', default='1-prev', type=str, help='"k-prev" or "all-prev"')
    ...
    # Use blurry CL
    subparsers.add_argument('--blurryCL', action='store_true', help='Noisy labels')
    ...
    subparsers.add_argument('--wo_sep_mask_e', default=-1, type=int,)
    subparsers.add_argument('--w_sep_mask_e', default=-1, type=int,)
    subparsers.add_argument('--wo_sep_mask_t', default=-1, type=int,)
    subparsers.add_argument('--w_sep_mask_t', default=-1, type=int,)
    ...
    # save (loss, noise) pairs
    subparsers.add_argument('--loss_noise_pair', action='store_true', help='check loss-noise pair')
