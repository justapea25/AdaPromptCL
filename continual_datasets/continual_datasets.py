...
class MyImageFolder(datasets.ImageFolder):
    ...
    """
    def __init__(self, root, transform=None, noisy_labels=False) -> None:
        self.root = root
...
class Imagenet_R(torch.utils.data.Dataset):
    def __init__(self, root, train=True, transform=None, target_transform=None,
                 download=False, noisy_labels=False):        
        self.root = os.path.expanduser(root)
        self.transform = transform
        self.target_transform=target_transform
        self.train = train
        ...
        self.data = MyImageFolder(fpath, transform=transform, noisy_labels=noisy_labels)
        # self.data = datasets.ImageFolder(fpath, transform=transform)
...
class VTAB(datasets.ImageFolder):
    def __init__(self, root, train=True, transform=None, target_transform=None, mode=None,
                    is_individual_prompt=False,**kwargs):
